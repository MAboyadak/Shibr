@php
    $parameters = [
        [
            ...
            'type' => 0,
            'format' => 'string',
            'description' => __('The pixel type.') . ' ' . __('Possible values are: :values.', ['values' => '<code>'.implode('</code>, <code>', array_keys(config('pixels'))).'</code>']) .' ' . __('Defaults to: :value.', ['value' => '<code>desc</code>'])
        ], [
            'name' => 'sort',
            'type' => 0,
            'format' => 'string',
